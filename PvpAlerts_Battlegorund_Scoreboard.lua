...
function ScoreboardList:Setup( )
	ZO_ScrollList_AddDataType(self.list, 69, "PVP_ScoreboardRow", 28, function(control, data) self:SetupPlayerRow(control, data) end)
...
PVP.sampleSBdata = {
	{class = 1, name = "Miat Did Nothing Wrong^Mx" , kills = 5, deaths = 2, assists = 3, damage = 10000, healing = 2000, points = 350, alliance = 1, rank = 20, specials=3, medals={
	...
	{class = 2, name = "Miat Did Something Wrong^Fx" , kills = 3, deaths = 2, assists = 10, damage = 3200, healing = 1000, points = 900, alliance = 1, rank = 238, specials=0, medals={
	...
	{class = 3, name = "Miat Did Nothing^Fx" , kills = 18, deaths = 20, assists = 100, damage = 10000000, healing = 2000000, points = 800, alliance = 1, rank = 9999, specials=0, medals={
		{medalId = 10, medalCount = 2},
		{medalId = 12, medalCount = 5},
		{medalId = 13, medalCount = 2},
	...
	{class = 2, name = "Miat-For-Cookies^Fx" , kills = 30, deaths = 20, assists = 100, damage = 10000000, healing = 3000000, points = 700, alliance = 1, rank = 9999, specials=1, medals={
		{medalId = 10, medalCount = 2},
		{medalId = 7, medalCount = 1},
		{medalId = 18, medalCount = 1},
	}},
	{class = 3, name = "Cookies Rebellion^Fx" , kills = 30, deaths = 20, assists = 100, damage = 10000000, healing = 3000000, points = 600, alliance = 2, rank = 9999, specials=0, medals={
	...
	{class = 2, name = "Testing Cookies^Fx" , kills = 80, deaths = 200, assists = 100, damage = 10000000, healing = 300000, points = 310, alliance = 2, rank = 1, specials=0, medals={
	...
	{class = 2, name = "Not-Bob^Fx" , kills = 30, deaths = 20, assists = 100, damage = 10000000, healing = 3000000, points = 300, alliance = 3, rank = 55, specials=0, medals={
		{medalId = 4, medalCount = 10},
		{medalId = 5, medalCount = 3},
	}},
	{class = 1, name = "Definitely-Not-Bob^Fx" , kills = 30, deaths = 20, assists = 100, damage = 10000000, healing = 3000000, points = 200, alliance = 3, rank = 9999, specials=0, medals={
		{medalId = 18, medalCount = 3},
		{medalId = 19, medalCount = 1},
	}},
	{class = 3, name = "Cookies For Bob^Fx" , kills = 30, deaths = 20, assists = 100, damage = 10000000, healing = 3000000, points = 1100, alliance = 3, rank = 9999, specials=0, medals={
		{medalId = 1, medalCount = 2},
		{medalId = 2, medalCount = 5},
		{medalId = 3, medalCount = 2},
		{medalId = 4, medalCount = 1},
...
function ScoreboardList:SetupPlayerRow( control, data )
	...
	local function GetPlayerRankIcon(rank, isPoints)
		...
		elseif rank == 2 then
			return PVP_SILVER_COLOR:Colorize(zo_iconFormatInheritColor("esoui/art/tutorial/ava_rankicon64_general.dds", 30, 30))
		elseif rank ==3 then
			return PVP_BRONZE_COLOR:Colorize(zo_iconFormatInheritColor("esoui/art/tutorial/ava_rankicon64_general.dds", 30, 30))
		end
	end
	...
	elseif data.alliance == 2 then
		control:GetNamedChild("BG"):SetTexture("EsoUI/Art/Battlegrounds/battlegrounds_scoreboard_highlightStrip_green.dds")
		currentBg = bg2
	...
	if isPlayer then 
		...
		control:GetNamedChild("Rank"):SetColor(GetInterfaceColor(INTERFACE_COLOR_TYPE_TEXT_COLORS, INTERFACE_TEXT_COLOR_NORMAL))
		control:GetNamedChild("Kills"):SetColor(GetInterfaceColor(INTERFACE_COLOR_TYPE_TEXT_COLORS, INTERFACE_TEXT_COLOR_NORMAL))
		control:GetNamedChild("Deaths"):SetColor(GetInterfaceColor(INTERFACE_COLOR_TYPE_TEXT_COLORS, INTERFACE_TEXT_COLOR_NORMAL))
		control:GetNamedChild("Assists"):SetColor(GetInterfaceColor(INTERFACE_COLOR_TYPE_TEXT_COLORS, INTERFACE_TEXT_COLOR_NORMAL))
		control:GetNamedChild("Damage"):SetColor(GetInterfaceColor(INTERFACE_COLOR_TYPE_TEXT_COLORS, INTERFACE_TEXT_COLOR_NORMAL))
		control:GetNamedChild("Healing"):SetColor(GetInterfaceColor(INTERFACE_COLOR_TYPE_TEXT_COLORS, INTERFACE_TEXT_COLOR_NORMAL))
...
function PVP_ScoreboardRow_OnMouseEnter( control )
	...
	local formattedName = zo_iconFormatInheritColor(PVP.classIcons[control.data.class], 35, 35)..zo_strformat(SI_UNIT_NAME, control.data.name)
	...
	PVPScoreboardTooltip:AddLine(ZO_NORMAL_TEXT:Colorize("Total points: ")..PVP_MEDAL_TOOLTIP_NAME_COLOR:Colorize(control.data.points), "ZoFontWinH2", 1, 1, 1, LEFT, MODIFY_TEXT_TYPE_NONE, TEXT_ALIGN_LEFT, true)
	ZO_Tooltip_AddDivider(PVPScoreboardTooltip)
	local numMedalsToDisplay = #control.data.medals<5 and #control.data.medals or 5
	PVPScoreboardTooltip:AddLine(ZO_NORMAL_TEXT:Colorize("Top Medals: "), "ZoFontWinH2", 1, 1, 1, LEFT, MODIFY_TEXT_TYPE_NONE, TEXT_ALIGN_LEFT, true)
	PVP.bgScoreboard.list.medalsPool:ReleaseAllObjects()
	for i = 1, numMedalsToDisplay do
		...
		medalControl:GetNamedChild('Description'):SetText(tostring(totalPoints)..' points'..' ('..tostring(control.data.medals[i].medalCount)..'x'..tostring(points)..')')
...
function PVP_Medal_OnMouseEnter( control )
	...
	if description~="" then
		InformationTooltip:AddLine(description, "ZoFontWinH4", 0.772, 0.760, 0.619, LEFT, MODIFY_TEXT_TYPE_NONE, TEXT_ALIGN_CENTER, true)
		ZO_Tooltip_AddDivider(InformationTooltip)
	end
	InformationTooltip:AddLine(tostring(totalPoints)..' points'..' ('..tostring(control.medalCount)..'x'..tostring(points)..')', "ZoFontWinH4", 0.627,0.627,0.627, LEFT, MODIFY_TEXT_TYPE_NONE, TEXT_ALIGN_CENTER)
end
